...
Only set this up when we actually reach the "accuracy-ceiling comparison" experiment in [04_MODEL_TRAINING.md](04_MODEL_TRAINING.md) (EfficientNetV2-S / Swin-Tiny runs that may be slow on 8GB VRAM at larger batch sizes). Steps when that time comes:
