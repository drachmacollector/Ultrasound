...
### Phase 0 — Orientation
- [ ] `[M]` Read `00_PROJECT_OVERVIEW.md` fully before starting anything
...
### Phase 1 — Environment (`01_ENVIRONMENT_SETUP.md`)
...
### Phase 2 — Datasets (`02_DATASETS.md`)
...
### Phase 3 — Data Pipeline (`03_DATA_PIPELINE.md`)
...
### Phase 4 — Model Training (`04_MODEL_TRAINING.md`)
...
### Phase 5 — Temporal Smoothing & Real-Time Pipeline (`05_TEMPORAL_SMOOTHING_AND_REALTIME.md`)
...
### Phase 6 — Evaluation & Validation (`06_EVALUATION_VALIDATION.md`)
...
- [ ] `[M+A]` Write final `EVAL_REPORT.md` including honest limitations section

### Phase 7 — Stretch Goals (`07_STRETCH_GOALS_AND_ROADMAP.md`) — only after Phases 0-6 are fully done
...
Paste in, at minimum: this file + `00_PROJECT_OVERVIEW.md`. Add the phase-specific file (`01`-`07`) matching whatever step you've reached. You don't need to paste all nine files into every new chat — just the overview plus whichever phase you're actively working on, and the checklist to show where you are.
